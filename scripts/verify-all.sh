...
step 'iOS bundle'
npx expo export --platform ios --output-dir "${TMPDIR:-/tmp}/namewell-verify-ios" >/dev/null

step 'Android bundle'
npx expo export --platform android --output-dir "${TMPDIR:-/tmp}/namewell-verify-android" >/dev/null
