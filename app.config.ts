...
/**
 * Store identity and native configuration for Namewell.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Namewell works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  backgroundColor: '#140B13',
  primaryColor: '#F9A8D4',
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.namewell',
    buildNumber: BUILD,
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.namewell',
