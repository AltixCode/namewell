...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs namewell`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.namewell` |
| Scheme | `namewell://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.namewell.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/namewell` |
